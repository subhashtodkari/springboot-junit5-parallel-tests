 ...
 */
public class FlakyTestExtension implements TestTemplateInvocationContextProvider, BeforeTestExecutionCallback,
    ...
    /**
     * Check that test method contain {@link FlakyTest} annotation
     *
    ...
    public Stream<TestTemplateInvocationContext> provideTestTemplateInvocationContexts(ExtensionContext extensionContext) {
        ...
        FlakyTest annotationParams = extensionContext.getTestMethod()
                .flatMap(testMethods -> findAnnotation(testMethods, FlakyTest.class))
     ...
     *
     * @param test        - FlakyTest annotation
     ...
     */
    private RepeatedIfExceptionsDisplayNameFormatter displayNameFormatter(FlakyTest test, String displayName) {
        String pattern = test.name().trim();
        if (StringUtils.isBlank(pattern)) {
            pattern = Optional.of(test.name())
                    .orElseThrow(() -> new RepeatedIfException("Exception occurred with name parameter of FlakyTest annotation"));
        }
